...
class RepositoryMySQL {
    ...
    getAllProduct(numPerPage, page, qry) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let numRows;
                let queryPagination;
                ...
                let [results2, fields2] = yield connection_1.Connection.mySQL2Pool.query({
                    sql: `select * from Product po left join Product_Picture_Mapping ppm on po.Id = ppm.ProductId 
            left join Picture pi on ppm.PictureId = pi.Id
            where po.Name like '%${qry}%' and po.MarkAsNew=0 && po.Deleted=0 && po.Deprecated=0 order by po.Id limit ${limit};`,
                });
